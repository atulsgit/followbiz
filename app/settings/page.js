        ...
        <div style={s.section}>
          ...
          <div style={s.billingInfo}>
            <div style={s.billingRow}>
              ...
              <span style={{ ...s.billingValue, color: '#f97316', textTransform: 'capitalize' }}>
...
const s = {
  ...
  section: { background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 16, padding: '28px 32px', marginBottom: 20 },
  ...
  billingInfo: { background: 'var(--surface2)', border: '1px solid var(--border)', borderRadius: 12, overflow: 'hidden', marginBottom: 20 },
  billingRow: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '14px 18px', borderBottom: '1px solid var(--border-subtle)' },
  billingLabel: { color: 'var(--muted)', fontSize: '0.88rem' },
  billingValue: { color: 'var(--text)', fontSize: '0.88rem', fontWeight: 500 },
  ...
  modal: { background: 'var(--surface)', border: '1px solid rgba(255,80,80,0.2)', borderRadius: 20, padding: 40, maxWidth: 420, width: '90%' },
  modalTitle: { fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: '1.2rem', fontWeight: 700, color: 'var(--text)', marginBottom: 12 },
  modalText: { color: 'var(--muted)', fontSize: '0.9rem', lineHeight: 1.7, marginBottom: 28 },
